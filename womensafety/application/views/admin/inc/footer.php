...
<!-- PAGE PLUGINS -->
<!-- jQuery Mapael -->
<script src="<?=base_url()?>assets/admin/assets/plugins/jquery-mousewheel/jquery.mousewheel.js"></script>
<script src="<?=base_url()?>assets/admin/assets/plugins/raphael/raphael.min.js"></script>
<script src="<?=base_url()?>assets/admin/assets/plugins/jquery-mapael/jquery.mapael.min.js"></script>
<script src="<?=base_url()?>assets/admin/assets/plugins/jquery-mapael/maps/usa_states.min.js"></script>
<!-- ChartJS -->
...
<script src="<?=base_url()?>assets/admin/assets/dist/js/pages/dashboard2.js"></script>
</body>
</html>